...
const Lobby = () => {
    const { gameState, joinRoom, connectSocket, startBotGame } = useGame();
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-purple-900 via-slate-900 to-black flex items-center justify-center p-6">
                <div className="bg-slate-800/50 backdrop-blur-lg p-8 rounded-2xl border-2 border-purple-500 max-w-md w-full">
                    ...
                    <p className="text-gray-300 text-center mb-6">Room ID: {gameState.roomId}</p>

                    <div className="bg-slate-900/50 rounded-lg p-6 mb-6">
                        <p className="text-gray-400 text-sm mb-3">Players:</p>
                        <div className="space-y-2">
                            <div className="flex items-center gap-3 bg-green-900/30 p-3 rounded-lg border border-green-500/30">
